...
namespace App\Filament\Admin\Resources\BlogResource\Table;
                ...
                Action::make('share')
                    ...
                    ->form([
                        Section::make('URL Preview')
                            ...
                            ->schema([
                                TextInput::make('url_preview')
                                    ->label('Content URL')
                                    ->default(fn ($record) => BlogResource::generateShareUrl($record, 'blog'))
                                    ->disabled()
                        ...
                        CheckboxList::make('platforms')
                            ...
                            ->required()
                            ->helperText('Select which social media platforms to share this blog post on'),
                    ])
                    ->action(function ($record, array $data) {
                        \App\Jobs\PublishToSocialMedia::dispatch($record, 'blog', $data['platforms']);

                        Notification::make()
                            ->title('Blog shared successfully!')
                            ->body('The blog post has been queued for sharing to selected social media platforms.')
                            ->success()
                            ->send();
                    })
                    ->modalHeading('Share Blog Post')
