    ...
    public static function configure(Schema $schema): Schema
    {
        ...
        return $schema->schema([
            Tabs::make('App Settings Tabs')->tabs([
                ...
                Tab::make(__('Organization'))->schema([
                ...
                Tab::make(__('Notifications'))->schema([
...
Sitemap: https://your-domain.com/sitemap.xml')
                ...
                Tab::make(__('PWA Settings'))->schema([
                    Section::make('Progressive Web App (PWA)')->description('Configure PWA settings for mobile app-like experience')->schema([
                        ...
                        Select::make('pwa_display_mode')
                            ...
                            ->default('standalone')
                            ->helperText('How app should be displayed when launched'),
                        Select::make('pwa_orientation')
                            ...
                            ->helperText('Preferred orientation for PWA'),
                        ...
                        \Filament\Forms\Components\TextInput::make('pwa_scope')
                            ...
                            ->placeholder('/')
                            ->default('/')
                            ->helperText('URL scope for PWA (controls which pages can be accessed)'),
                        Select::make('pwa_lang')
                            ...
                            ->default('en-US')
                            ->helperText('Primary language of PWA'),
                        Select::make('pwa_dir')
                            ...
                            ->default('ltr')
                            ->helperText('Text direction for PWA'),
                    ]),
                ]),
                ...
                Tab::make(__('Redis Configuration'))->schema([
