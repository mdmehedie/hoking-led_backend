...
class CaseStudyPolicy
{
    ...
    {
        return $user->hasPermissionTo('view casestudy');
    }
    ...
    {
        return $user->hasPermissionTo('create casestudy');
    }
    ...
    {
        return $user->hasPermissionTo('edit casestudy');
    }
    ...
    {
        return $user->hasPermissionTo('delete casestudy');
    }
